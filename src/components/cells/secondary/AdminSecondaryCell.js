...
class AdminSecondaryCell extends Component {

  handleChange = (setting, value) => {
    this.props.editFeature({feature: 'adminPanel', setting, value})
  }
...
const makeMapStateToProps = () => {
  ...
  const mapStateToProps = (state) => ({
    featureSettings: getFeatureSettings(state[STORE_FEATURES], 'adminPanel')
  })
